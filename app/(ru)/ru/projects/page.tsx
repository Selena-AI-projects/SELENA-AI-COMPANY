...
const journalDescription =
  "Собственные проекты проходят замер публично: с чего начали, что показали цифры и что мы поправили. С датами, с нулями и без переписанных задним числом выводов.";
