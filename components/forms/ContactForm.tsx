...
export function ContactForm() {
  ...
  useEffect(() => {
    trackPublicEvent("form_view", { form_id: "contact_brief" });
  }, []);
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    trackPublicEvent("form_start", { form_id: "contact_brief" });
  ...
  return (
    ...
    <form onSubmit={handleSubmit} noValidate className="card-premium p-6 sm:p-8">
      ...
      <button
        ...
        className={cn(
          "mt-7 inline-flex w-full items-center justify-center gap-2 rounded-full bg-copper-deep px-8 py-4 text-base font-medium text-surface shadow-[0_10px_24px_-12px_rgba(185,130,91,0.65)] transition-all duration-300 hover:-translate-y-px hover:bg-copper-deeper disabled:cursor-wait disabled:opacity-70 sm:w-auto",
        )}
      >
