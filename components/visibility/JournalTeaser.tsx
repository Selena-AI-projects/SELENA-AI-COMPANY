      ...
      <Container>
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-muted">
            Наши проекты проходят ту же лестницу публично: с датами, с числами
            и с отдельной строкой о том, чего эти числа не доказывают. Включая тот
            проект, у которого на старте ноль показов. Один проект в списке чужой — он
            опубликован с разрешения владельца.
          </p>
        </div>
