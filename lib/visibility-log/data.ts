...
export const journalProjects: JournalProject[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        doesNotProve: [
          { kind: "text", text:
            "Замер сделан по каналу «через API» — это собственные знания моделей. Что ответит ChatGPT живому человеку с включённым веб-поиском, здесь не проверялось: это отдельный канал." },
          { kind: "text", text:
      ...
      },
      {
        ...
        body: [
          ...
          { kind: "text", text:
            "Пересобрали по одному каноническому ресурсу Search Console, два окна ровно по 28 дней." },
    ...
    entries: [
      ...
      },
      {
        ...
        body: [
          ...
          { kind: "list", title: "Пересобрали по каноническому ресурсу Search Console", items: [
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        body: [
          { kind: "text", text:
            "Пересобрали по каноническому ресурсу Search Console, два окна ровно по 28 дней." },
    ...
    entries: [
      {
        ...
        doesNotProve: [
          { kind: "text", text:
            "Замер сделан по каналу «через API» — это собственные знания моделей, без веб-поиска." },
          { kind: "text", text:
