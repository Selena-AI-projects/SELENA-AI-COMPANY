...
export const ruHomepage = {
  ...
  strategyCall: {
    ...
    text: "Не готовы к полному аудиту? Перед звонком вы присылаете вопросы и данные о процессе — так весь час в Zoom уходит на разбор, а не на сбор информации. После звонка — короткий документ: что я увидела и первые шаги, которые можно сделать сразу. Полностью засчитывается в AI-аудит в течение 30 дней.",
