...
export const ruHomepage = {
  ...
  hero: {
    ...
    subheadline:
      "ChatGPT, Gemini и Perplexity уже отвечают на вопросы вроде «куда пойти поужинать» и «кто рядом делает это лучше всех». AI Visibility измеряет, попадает ли ваш бизнес в эти ответы — начиная с бесплатной проверки того, что машины могут прочитать на вашем сайте. AI Systems строит внутренние процессы, на которых держится рост.",
    ...
    trustLine:
      "Одна компания, два понятных направления: AI Visibility измеряет снаружи, AI Systems строит внутри. Selena Lab поддерживает оба исследованиями.",
    directions: {
      visibility: {
        ...
        ladderLabel: "1 бесплатный вход + 4 платных варианта",
