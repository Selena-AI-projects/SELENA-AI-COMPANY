...
export const ruHomepage = {
  ...
  cinema: {
    ...
    measurement: {
      ...
      intro:
        "Четыре шага, одинаковые на любом тарифе: реальные вопросы, живые системы, сохранённые ответы, отчёт с приоритетами.",
      honestyNote:
      ...
      slides: [
        ...
        },
        {
          ...
          text: "До 25 реальных вопросов ваших клиентов — каждой системе, по расписанию. Каждый раз одинаково, без ручной подгонки.",
