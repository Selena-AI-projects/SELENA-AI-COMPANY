  ...
  faq: [
    {
      ...
      a: "$49: ChatGPT, Gemini и Perplexity — измерение, конкуренты, сравнение, источники и рекомендации. $79 добавляет расширенные AI-системы и Google Maps / Local Visibility только с подтверждённым автоматическим production-замером. Visitor View и API View разделены. Ручной Ask Maps / Local AI в подписку не входит. Регулярные подписки пока в раннем доступе.",
    },
    {
      q: "Где доступно ручное исследование Google Ask Maps / Local AI?",
      a: "В человеческом конкурентном аудите за $399, где это применимо: исследование 3–5 конкурентов, страниц, отзывов, источников и Local evidence; 60-минутная сессия и проверенный Action Plan. В Managed Discovery за $2,490 на 90 дней ручные проверки и сопоставимая перепроверка возможны только в согласованном объёме, а не как еженедельный автоматический замер.",
    },
    {
