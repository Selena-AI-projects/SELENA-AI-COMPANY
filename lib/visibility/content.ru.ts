        ...
        plans: [
          {
            ...
            href: visibilityRoutes.ru.check,
            ctaLabel: "Начать с бесплатной проверки — результат сразу",
          },
          {
        ...
        plans: [
          ...
          },
          {
            ...
            features: [
              ...
              "До 10 часов внедрения нашими руками: сайт, тексты, разметка, профили",
              ...
              "Гарантия выполнения: весь объём плана сделан в срок — иначе возврат или бесплатная доработка",
              "Гарантия измеримости: «до» и «после» снимаются одной конфигурацией — динамика видна честно",
              "Чего не обещаем: конкретное место в ответах AI — его не контролирует никто",
