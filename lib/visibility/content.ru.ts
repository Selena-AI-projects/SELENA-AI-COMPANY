...
export const visibilityContentRu: VisibilityContent = {
  ...
  pricing: {
    ...
    paidPlans: {
      heading: "Бесплатный вход и четыре платных варианта — построчное сравнение",
      intro:
        "Одна строка — один вопрос. Ведите взгляд по строке и сравнивайте варианты между собой.",
      scrollHint: "Таблица прокручивается вбок — названия строк остаются на месте.",
      comparisonLabels: {
        offer: "Вариант",
        status: "Статус",
        bestFor: "Для кого",
