...
export const visibilityContentRu: VisibilityContent = {
  ...
  checkForm: {
    ...
    intro:
      "Проверьте, могут ли машины получить и понять информацию вашего сайта. Доказательства и исправления — без регистрации и карты. Техническая проверка не показывает, рекомендуют ли нейросети ваш бизнес.",
