...
export const visibilityContentEn: VisibilityContent = {
  ...
  verificationCycle: {
    ...
    stages: [
      {
        ...
        label: "Measure",
        tier: "core",
        benefit: "How AI answers your guests' questions today",
      ...
      },
      {
        ...
        label: "Evidence",
        tier: "support",
        benefit: "Every AI answer kept with its date and source",
      ...
      },
      {
        ...
        tier: "core",
        benefit: "What to fix, in what order, and why",
      ...
      },
      {
        ...
        tier: "support",
        benefit: "Every action has an owner and a priority",
      ...
      },
      {
        ...
        label: "Recheck",
        tier: "support",
        benefit: "The next measurement under the same conditions",
      ...
      },
      {
        ...
        tier: "core",
        benefit: "Before and after side by side: changed or not",
      ...
      },
      {
        ...
        tier: "support",
        benefit: "A short weekly digest with a link to the workspace",
    ...
    statuses: ["new", "still open", "needs recheck", "verified", "closed"],
    detailsLabel: "How each stage works and the rules it keeps",
    loopRule:
  ...
  checkForm: {
    ...
    intro:
      "Check whether machines can access and understand your public website. Evidence and fixes appear here without a login or card. This technical check does not test whether AI recommends your business.",
